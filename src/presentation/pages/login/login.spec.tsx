...
const simulateValidSubmit = (sut: RenderResult, email = faker.internet.password(), password = faker.internet.password()): void => {
...
const populateEmailField = (sut: RenderResult, email = faker.internet.password()): void => {
